...
if fileExists("/proc/stb/encoder/0/vcodec"):
	...
	if getMachineBuild() in ('u5','u51','u52','u53','u54','u55','u56','u5pvr','sf8008','sf8008m','beyonwizv2','gbmv200','ustym4kpro','viper4k','h9','h10','h9combo','hd60','hd61','multibox','multiboxse'):
