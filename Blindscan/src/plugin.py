...
class Blindscan(ConfigListScreen, Screen):
	...
	def createSetup(self):
		...
		if nim.canBeCompatible("DVB-S"):
			...
			self.list.append(getConfigListEntry(_("Network scan"), self.scan_networkScan, _('CAUTION: Default is "no". This feature will find channels outside your user defined frequency and symbol rate limits. Transponder data is harvested from the NIT. If you are trying to filter out services, do not use this feature.')))
