...
def initLED():
	...
	if config.plugins.VFD_Giga.showClockDeepStandby.value == 'True':
		...
		forcmd = '0'
	if BOX in ("gbquad", "gbquad4k", "gb800ueplus", "gbquadplus", "gbultraue", "gbultraueh", "gbipbox", "gbx1", "gbx2", "gbx3", "gbx3h"):
...
class LED_GigaSetup(ConfigListScreen, Screen):
	...
	def createSetup(self):
		...
		if config.plugins.VFD_Giga.setLed.value:
			...
			if BOX not in ("gbquad", "gbquad4k", "gb800ueplus", "gb800seplus", "gbquadplus", "gbipbox", "gbultra", "gbultraue", "gbultraueh", "gbultrase", "gbx1", "gbx2", "gbx3", "gbx3h"):
