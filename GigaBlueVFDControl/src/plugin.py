...
def leaveStandby():
	...
	if BOX in ('gb800seplus', 'gbultra', 'gbultrase', 'gbtrio4kpro', 'gbtrio4k', 'gbip4kled'):
...
def initLED():
	...
	if config.plugins.VFD_Giga.showClockDeepStandby.value == 'True':
		...
		forcmd = '0'
	if BOX in ("gbtrio4kpro", "gbtrio4k", "gbip4kled", "gbquad", "gbquad4k", "gbquad4kpro", "gbue4k", "gb800ueplus", "gbquadplus", "gbultraue", "gbultraueh", "gbipbox", "gbx1", "gbx2", "gbx3", "gbx3h", "gbx34k"):
	...
	if BOX in ('gbquad4k', 'gbquad4kpro', 'gbue4k', 'gbquadplus'):
...
class LED_GigaSetup(ConfigListScreen, Screen):
	def __init__(self, session, args=None):
		...
		if BOX in ("gbquad", "gbquad4k", "gbquad4kpro", "gbue4k", "gb800ueplus", "gbquadplus", "gbultraue", "gbultraueh", "gbipbox", "gbx1", "gbx2", "gbx3", "gbx3h", "gbx34k"):
	...
	def createSetup(self):
		...
		if config.plugins.VFD_Giga.setLed.value:
			...
			if BOX not in ("gbtrio4kpro", "gbtrio4k", "gbip4kled", "gbquad", "gbquad4k", "gbquad4kpro", "gbue4k", "gb800ueplus", "gb800seplus", "gbquadplus", "gbipbox", "gbultra", "gbultraue", "gbultraueh", "gbultrase", "gbx1", "gbx2", "gbx3", "gbx3h", "gbx34k"):
		...
		if BOX in ('gb800se', 'gb800solo', "gb800seplus", "gbultra", "gbultrase", "gbtrio4kpro", "gbtrio4k", "gbip4kled"):
